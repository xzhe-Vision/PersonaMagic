...
class CheckpointHandler:
    ...
    def save_model(self, text_encoder: PersonaCLIPTextModel,
    ...
    def save_learned_embeds(self, text_encoder: PersonaCLIPTextModel, accelerator: Accelerator, save_name: str):
        """
        ...
        learned_embeds_dict = {}
        for i in range(len(self.placeholder_token_string)):
            learned_embeds_dict[self.placeholder_token_string[i]] = learned_embeds[i]
        torch.save(learned_embeds_dict, self.save_root / save_name)

    def save_mapper(self, text_encoder: PersonaCLIPTextModel, save_name: str):
    ...
    @staticmethod
    def load_my_mapper(mapper_path: Path) -> Tuple[RunConfig, Mapper]:
        ...
        if isinstance(encoder, TimePositionalEncoding):
    ...
    def load_learned_embed_in_clip(learned_embeds_path: Path,
        ...
        placeholder_token = trained_tokens
