...
class ValidationHandler:
    ...
    def infer_on_prompt(self, pipeline: StableDiffusionPipeline,
        ...
        prompt_embeds = self.compute_embeddings(prompt_manager=prompt_manager, prompt=prompt, word_embedding=word_embedding, image_embedding=image_embedding)
        all_images = []
    ...
    @staticmethod
    def compute_embeddings(prompt_manager: PromptManager, prompt: str, word_embedding: torch.Tensor, image_embedding: torch.Tensor) -> torch.Tensor:
        with torch.autocast("cuda"):
            with torch.no_grad():
                prompt_embeds = prompt_manager.my_embed_prompt(prompt, word_embedding, image_embedding)
